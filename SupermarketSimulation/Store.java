...
public class Store {
    ...
    public void initializeNodes() {
        if (name.equals("Store 1")) {
            ...
            n1.setEntrance();
            Node n2 = new Node(425, 325);
            
            Node n3 = new Node(350, 325);
            Node n4a = new Node(275, 325);
            Node n5a = new Node(200, 325);
            Node n6a = new Node(125, 325);
            Node n7a = new Node(50, 325);
            
            Node n4b = new Node(350, 225);
            Node n5b = new Node(275, 225);
            Node n6b = new Node(200, 225);
            Node n7b = new Node(125, 225);
            Node n8b = new Node(50, 225);
