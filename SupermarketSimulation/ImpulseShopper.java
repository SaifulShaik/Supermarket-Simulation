...
public class ImpulseShopper extends Customer
{
    ...
    public ImpulseShopper(Node n) 
    {
        ...
        {
            new GreenfootImage("impulseShopper/right1.png"),
            new GreenfootImage("impulseShopper/right2.png")
        };
        leftImages = new GreenfootImage[] 
        {
            new GreenfootImage("impulseShopper/left1.png"),
            new GreenfootImage("impulseShopper/left2.png")
        };
        upImages = new GreenfootImage[] 
        {
            new GreenfootImage("impulseShopper/up1.png"),
            new GreenfootImage("impulseShopper/up2.png")
        };
        downImages = new GreenfootImage[] 
        {
            new GreenfootImage("impulseShopper/down1.png"),
            new GreenfootImage("impulseShopper/down2.png")
        };
    }
